    ...
    public class ConverterController : ControllerBase
    {
            ...
            [Required][FromQuery] double value)
        {
            return (from, to) switch
            {
                ...
                (ETemperatureUnit.Fahrenheit, ETemperatureUnit.Celsius) => Converter.ToCelsius(ETemperatureUnit.Fahrenheit, value),
                (ETemperatureUnit.Kelvin, ETemperatureUnit.Celsius) => Converter.ToCelsius(ETemperatureUnit.Kelvin, value),
